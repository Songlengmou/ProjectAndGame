...
public class RectLine extends Container {
    ...
    //---(2)
    private final top.yunp.lib.java.event.EventListener<top.yunp.androidgame2d.events.TweenEvent, top.yunp.androidgame2d.tween.Tween> tweenEndHandler = new EventListener<TweenEvent, Tween>() {
        @Override
    ...
    private boolean tweenRunning = false; //动画运行状态
